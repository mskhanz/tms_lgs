...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Dear <?php echo e($enrollment->trainee->name); ?>,</p>
            ...
            <table style="width: 100%; margin: 20px 0; border-collapse: collapse;">
                <tr style="background-color: #e9e9e9;">
                    ...
                    <td style="padding: 10px; border: 1px solid #ddd;"><?php echo e($enrollment->trainingBatch->trainingProgram->title); ?></td>
                </tr>
                <tr>
                    <td style="padding: 10px; border: 1px solid #ddd;"><strong>Batch Code:</strong></td>
                    <td style="padding: 10px; border: 1px solid #ddd;"><?php echo e($enrollment->trainingBatch->batch_code); ?></td>
                </tr>
                <tr style="background-color: #e9e9e9;">
                    <td style="padding: 10px; border: 1px solid #ddd;"><strong>Start Date:</strong></td>
                    <td style="padding: 10px; border: 1px solid #ddd;"><?php echo e($enrollment->trainingBatch->start_date->format('F d, Y')); ?></td>
                </tr>
                <tr>
                    <td style="padding: 10px; border: 1px solid #ddd;"><strong>End Date:</strong></td>
                    <td style="padding: 10px; border: 1px solid #ddd;"><?php echo e($enrollment->trainingBatch->end_date->format('F d, Y')); ?></td>
                </tr>
                <tr style="background-color: #e9e9e9;">
                    <td style="padding: 10px; border: 1px solid #ddd;"><strong>Venue:</strong></td>
                    <td style="padding: 10px; border: 1px solid #ddd;"><?php echo e($enrollment->trainingBatch->venue ?? 'To be announced'); ?></td>
                </tr>
            </table>
            ...
            <p style="text-align: center; margin: 30px 0;">
                <a href="<?php echo e(url('/trainee/dashboard')); ?>" class="button">View Dashboard</a>
            </p>
...
<?php /**PATH C:\xampp\htdocs\tms_lgs\resources\views/emails/enrollment-notification.blade.php ENDPATH**/ ?>