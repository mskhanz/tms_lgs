...
<form method="POST" action="{{ route('admin.roles.update', $role->id) }}">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card mb-3">
                <div class="card-header bg-light">
                    <h6 class="mb-0"><i class="bi bi-info-circle me-2"></i>Role Details</h6>
                </div>
                <div class="card-body">
                    <div class="mb-2">
                    ...
                    <div class="mb-2">
                        <strong>Created:</strong> {{ $role->created_at->format('d M, Y') }}
                    </div>
                    <div>
                        <strong>Last Updated:</strong> {{ $role->updated_at->format('d M, Y') }}
                    </div>
                </div>
            </div>
            ...
            <div class="alert alert-warning">
                ...
                <small>This is a protected system role. Be careful when modifying permissions.</small>
            </div>
            @endif

            <div class="card">
                <div class="card-header bg-info text-white">
                    <h6 class="mb-0"><i class="bi bi-shield-check me-2"></i>Permission Tips</h6>
                </div>
                <div class="card-body small">
                    <ul class="mb-0">
                        <li>Review permissions carefully before saving</li>
                        <li>Changes affect all users with this role</li>
                        <li>Test role permissions after updating</li>
                    </ul>
                </div>
            </div>
        </div>
