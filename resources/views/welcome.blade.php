...
<body>
    <nav class="home-nav">
        <div class="container home-nav-inner">
            <a href="{{ route('home') }}" class="home-brand">
                <img src="{{ asset('images/kp-logo.png') }}" alt="KP Logo">
            ...
            <div class="home-nav-actions">
                @auth
                <a href="{{ route('dashboard') }}" class="btn-home-primary">
                ...
                @else
                <a href="{{ route('login') }}" class="btn-home-outline">
                    <i class="bi bi-box-arrow-in-right"></i> Login
                </a>
                <a href="{{ route('register') }}" class="btn-home-primary">
        ...
        <div class="container home-hero-content">
            <div class="row align-items-center g-4">
                <div class="col-lg-7">
                    ...
                    <h1>{{ config('app.name') }} <span>{{ config('app.tagline') }}</span></h1>
                    ...
                    <div class="home-hero-actions">
                        @auth
                        <a href="{{ route('dashboard') }}" class="btn-home-primary btn-lg">
                            <i class="bi bi-speedometer2"></i> Go to Dashboard
                        </a>
                        @else
                        <a href="{{ route('login') }}" class="btn-home-primary btn-lg">
                            <i class="bi bi-box-arrow-in-right"></i> Sign In
                        </a>
                        <a href="{{ route('register') }}" class="btn-home-outline btn-lg">
                ...
                <div class="col-md-6">
                    <div class="portal-card">
                        ...
                        <ul>
                            ...
                            <li><i class="bi bi-check-circle-fill"></i> <strong>{{ config('app.name') }}</strong> — enrollments, attendance, quizzes &amp; certification tracking</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="home-cta">
            ...
            <p>Sign in to your account or register as a new trainee to access {{ config('app.name') }}.</p>
    ...
    <footer class="home-footer">
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-5">
                    <strong>{{ config('app.name') }}</strong>
                    <span class="d-block text-muted small mt-1">{{ config('app.tagline') }}</span>
            ...
            <div class="text-center">
                &copy; {{ date('Y') }} {{ config('app.name') }}, Local Governance School, Government of Khyber Pakhtunkhwa. All rights reserved.
            </div>
        </div>
    </footer>
