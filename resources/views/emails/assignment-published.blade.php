...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <table style="width: 100%; margin: 20px 0; border-collapse: collapse;">
                ...
                <tr>
                    ...
                    <td style="padding: 10px; border: 1px solid #ddd;">{{ $assignment->assignmentLabel() }}</td>
                </tr>
                <tr style="background-color: #e9e9e9;">
                    <td style="padding: 10px; border: 1px solid #ddd;"><strong>Due date:</strong></td>
                    <td style="padding: 10px; border: 1px solid #ddd;">
                        {{ $assignment->due_at ? $assignment->due_at->format('F d, Y h:i A') : 'No due date' }}
                    </td>
                </tr>
            </table>
            ...
            <p>{{ \Illuminate\Support\Str::limit(strip_tags($assignment->instructions), 300) }}</p>
            @endif

            <p style="text-align: center; margin: 30px 0;">
                <a href="{{ route('trainee.assignments.show', $assignment) }}" class="button">Open Assignment</a>
            </p>
        ...
        <div class="footer">
            <p>&copy; {{ date('Y') }} Local Governance School, Government of Khyber Pakhtunkhwa</p>
