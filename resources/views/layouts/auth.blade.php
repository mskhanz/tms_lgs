...
<div class="auth-shell">
    <div class="auth-left">
        ...
        <div class="left-inner">
            ...
            <p class="subtitle">{{ config('app.tagline') }}<br>Government of Khyber Pakhtunkhwa</p>
    ...
    <div class="auth-main">
        ...
        <div class="auth-footer-right">
            &copy; {{ date('Y') }} {{ config('app.name') }}, Local Governance School, Government of Khyber Pakhtunkhwa &mdash; All rights reserved.
        </div>
    </div>
</div>
